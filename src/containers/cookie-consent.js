...
import { Cookies as CookieStorage } from "react-cookie-consent";

export function CookieConsentContainer({ children }) {
  ...
  const cookieDeclineHandler = () => {
    CookieStorage.remove("_ga");
    CookieStorage.remove("_gat");
    CookieStorage.remove("_gid");
    closeCookieInfo();
  };
  ...
  return (
    <>
      {cookieInfoOpen && (
        <Modal
          openState={cookieInfoOpen}
          closeModal={closeCookieInfo}
          style={{ position: "absolute" }}
        >
          <Cookies data-testid="cookie-modal">
            <Cookies.Title>Cookie Policy for Moviechooser</Cookies.Title>
            <Cookies.Info>
              <p>
                This is the Cookie Policy for Moviechooser, accessible from
                moviechooser.co.uk
              </p>
              ...
              <p>Email: moviechooser.co.uk@domainsbyproxy.com</p>
            </Cookies.Info>
          </Cookies>
        </Modal>
      )}
      <Cookies data-testid="cookie-banner">
        <Cookies.Banner
          acceptHandler={closeCookieInfo}
          declineHandler={cookieDeclineHandler}
        >
          <Cookies.BannerText>
            <p>This website uses cookies to enhance your experience. </p>
            <button onClick={openCookieInfo}>Learn more.</button>
          </Cookies.BannerText>
        </Cookies.Banner>
      </Cookies>
    </>
